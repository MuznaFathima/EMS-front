...
<div className='container'>
  ...
  <FloatingLabel controlId="floatingInputfname" label="firstname" className='mb-3 col-lg-6'>
          <Form.Control type="text" value={normalInput.fname} placeholder="firstname" name='fname' onChange={e=>getandsetInput(e)}/>
        </FloatingLabel>
  
  
              {/* last name */}
  <FloatingLabel controlId="floatingInputlname" label="lastname" className='mb-3 col-lg-6'>
          <Form.Control type="text" value={normalInput.lname} placeholder="lastname"  name='lname' onChange={e=>getandsetInput(e)}/>
        </FloatingLabel>
  
              {/* Email*/}
  <FloatingLabel controlId="floatingInputemail" label="e-mail" className='mb-3 col-lg-6'>
          <Form.Control type="email" value={normalInput.email} placeholder="e-mail" name='email' onChange={e=>getandsetInput(e)} />
        </FloatingLabel>
  
              {/* mobile number */}
  <FloatingLabel controlId="floatingInputmobile" label="mobile" className='mb-3 col-lg-6'>
          <Form.Control type="text" value={normalInput.mobile} placeholder="mobile"  name='mobile' onChange={e=>getandsetInput(e)}/>
        </FloatingLabel>
  ...
  <FloatingLabel controlId="floatingInputlocation" label="location" className='mb-3 col-lg-6 mt-5'>
          <Form.Control type="text" value={normalInput.location} placeholder="location" name='location' onChange={e=>getandsetInput(e)}/>
        </FloatingLabel>
