...
<tr>
          ...
          <td><img src={`${BASE_URL}/uploads/${item.profile}`} style={{width:'70px',height:'70px'}} alt="no image" /></td>
          <td>
            ...
            <span onClick={()=>removeUser(item._id)}><i class="fa-solid fa-trash  fs-3"/></span>
          </td>
        </tr>
